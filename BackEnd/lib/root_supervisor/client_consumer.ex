defmodule RootSupervisor.ClientConsumer do
  use GenServer
  use AMQP
  ...
  defp process_message(%{"command" => "create", "client_id" => client_id} = msg, tag, state) do
    result = RootSupervisor.DynamicSupervisorClient.add_client_instance(client_id)
