defmodule FrontEndChatserver.LogDatabase do
  use GenServer
  ...
  @impl true
  def handle_cast({:store, msg}, state_logs) when is_binary(msg), do: {:noreply, [msg | state_logs]}

  @impl true
  def handle_cast({:store, msg}, state_logs) when is_map(msg), do: {:noreply, [Kernel.inspect(msg) | state_logs]}
